...
def main():
    ...
    knn_convert_model = make_pipeline(FunctionTransformer(rgb2lab, validate=True), KNeighborsClassifier(n_neighbors=8))
    
    rf_rgb_model = RandomForestClassifier(n_estimators=200, max_depth=20, min_samples_leaf=5)
    rf_convert_model = make_pipeline(FunctionTransformer(rgb2lab, validate=True), RandomForestClassifier(n_estimators=200, max_depth=20, min_samples_leaf=5))
